...
INSERT INTO ingredients (id_ingredient, name_ingredient, peso, medicion, kcal, grasas, grasas_saturadas, carbohidratos,
                         carbohidratos_azucares, fibra, proteinas, sal, precio)
VALUES (1001, "Aceite de Oliva Virgen extra, Hacendado", 1000, "ml", 822, 91.0, 13.0, 0, 0, 0, 0, 0, 4.25),
       (1002, "Aceite de Oliva Virgen extra Gran Selección, Hacendado", 750, "ml", 900, 91.0, 13.0, 0, 0, 0, 0, 0,
        4.50),
       ...
       (1017, "Sazonador al horno y microondas ajo y limón Hacendado con bolsa", 60, "g", 256, 1.1, 0.6, 50.8, 5.7, 8.2,
        6.6, 24.8, 1.40),
       (1018, "Sazonador al horno y microondas pollo y costillas a las hierbas provenzales Hacendado con bolsa", 48,
        "g", 252, 1.7, 0.6, 49.5, 26.5, 6.9, 6.2, 18.3, 1.40),
       ...
       (1033, "Salsa ligera Hacendado 60% menos de materia grasa", 500, "ml", 294, 31, 4.8, 6.5, 3.5, 0, 0.7, 2.1,
        1.40),
       ...
       (1042, "Tomate frito receta artesana Hacendado con aceite de oliva Tarro 560g", 560, "g", 201, 15.0, 2.1, 14.3,
        12.5, 0, 1.6, 0.9, 1.85),
       (1043, "Tomate frito receta artesana Hacendado con aceite de oliva Tarro 300g", 300, "g", 201, 15.0, 2.1, 14.3,
        12.5, 0, 1.6, 0.9, 1.45),
       (1044, "Tomate frito estilo casero Hacendado con aceite de oliva Brick 380g", 380, "g", 104, 5.0, 0.5, 12.4, 9.7,
        0, 2.0, 0.8, 1.05),
       (1045, "Tomate frito Hacendado con aceite de oliva 3 minibricks x 210g", 210, "g", 77, 3.5, 0.3, 9.5, 6.9, 0,
        1.5, 1.0, 0.95),
       (1046, "Tomate frito sin azúcares añadidos Hacendado Tarro 560g", 560, "g", 65, 3.5, 0.3, 6.5, 4.7, 0, 1.5, 1.2,
        1.05),
       (1047, "Tomate frito con cebolla Hacendado con aceite de oliva Brick 380g", 380, "g", 130, 8.5, 1.3, 11.0, 9.7,
        0, 1.4, 1.0, 1.20),
...
VALUES (2001, "Aceitunas manzanilla rellenas de anchoa Hacendado 3 botes x 50g", 50, "g", 150, 15.0, 2.9, 0.9, 0.5, 0,
        1.6, 2.6, 1.25),
       (2002, "Aceitunas manzanilla rellenas de anchoa Hacendado reducidas en sal 3 x 50g", 50, "g", 163, 15.6, 3.07,
        0.7, 0.5, 0, 1.7, 1.9, 1.60),
...
INSERT INTO ingredients (id_ingredient, name_ingredient, peso, medicion, kcal, grasas, grasas_saturadas, carbohidratos,
                         carbohidratos_azucares, fibra, proteinas, sal, precio)
VALUES (3001, "Arroz redondo Hacendado", 1000, "g", 344, 1.0, 0.2, 75.0, 0.5, 0, 8.2, 0.01, 0.95),
       ...
       (3008, "Garbanzo cocido pedrosillano Hacendado categoría extra", 400, "g", 90, 2.2, 0.5, 9.5, 0.7, 0.0, 5.5, 0.8,
        0.95),
       ...
       (3033, "Placas para canelones tradicionales Hacendado", 160, "g", 362, 1.1, 0.2, 75.0, 2.0, 4.0, 11.0, 0.01,
        0.70),
       (3034, "Cannelloni tubos precocidos Hacendado", 250, "g", 350, 1.5, 0.3, 72.6, 3.5, 3.0, 11.5, 0.005, 1.35)
;
INSERT INTO ingredients (id_ingredient, name_ingredient, peso, medicion, kcal, grasas, grasas_saturadas, carbohidratos,
                         carbohidratos_azucares, fibra, proteinas, sal, precio)
VALUES (4001, "Harina de trigo Hacendado", 1000, "g", 350, 1.3, 0.2, 73.0, 0.6, 3.0, 10.0, 0.02, 0.75),
       (4002, "Harina de fuerza Hacendado", 1000, "g", 340, 0.9, 0.2, 68.8, 0.4, 2.5, 13.0, 0.001, 0.95),
       (4003, "Preparado para bizcochos con levadura incorporada Hacendado", 1000, "g", 332.6, 1.14, 0.139, 69.79, 0.55,
        0.0, 10.10, 0.65, 1.05),
       ...
       (4006, "Chocolate negro 70% cacao fundir Hacendado 0% azúcares añadidos", 200, "g", 525, 42.0, 26.0, 35.0, 0.1,
        9.7, 8.7, 0.0, 1.55),
       ...
       (4010, "Masa fresca Hacendado hojaldre con mantequilla", 260, "g", 409, 23.6, 17.2, 42.2, 1.4, 0.0, 7.0, 1.2,
        2.80),
       ...
       (4018, "Pan de molde blanco sin corteza Hacendado 450g", 450, "g", 225, 2.1, 0.5, 42.0, 3.9, 3.0, 8.0, 1.1,
        1.25),
       ...
       (4021, "Pan de molde sin gluten blanco Hacendado 440g", 440, "g", 250, 11.0, 1.0, 28.0, 4.3, 9.5, 4.3, 1.3,
        3.10),
